...
folder are mapped to the application's root namespace, 'PurchaseBot.Client'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'PurchaseBot.Client' in the same way
as `"PurchaseBot.Client/sass/src"`.
